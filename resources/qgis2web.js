...
map.getView().fit([-711428.389896, 1012937.102862, 492484.982475, 1713418.755661], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DISTRIBUTION SPATIALE DE LA POPULATION DU BURKINA FASO EN 2019</h2>';
        return titleElement;
    })(),
